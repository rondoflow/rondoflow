---
name: analyze-web-performance-vitals
description: "Analyzes web performance using Chrome DevTools MCP. Measures Core Web Vitals (FCP, LCP, TBT, CLS, Speed Index), identifies render-blocking resources, network dependency chains, layout shifts, caching issues, and accessibility gaps. Use when asked to audit, profile, debug, or opt…"
category: "AI & Agents"
author: community
version: "1.0.0"
icon: bot
