...
Related categories: `/strategy` (contextual wisdom for acting within games), `/decision` (single-player choice without strategic interaction), `/social-dynamics` (power dynamics and coalition politics).
