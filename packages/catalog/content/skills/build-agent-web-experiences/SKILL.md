---
name: build-agent-web-experiences
description: "Build agent-facing web experiences with ATXP-based authentication, following the ClawDirect pattern. Use this skill when building websites that AI agents interact with via MCP tools, implementing cookie-based agent auth, or creating agent skills for web apps. Provides templates…"
category: "AI & Agents"
author: community
version: "1.0.0"
icon: bot
