...
See the [API reference](/reference/api) and [data model](/reference/data-model) for full details.

## Related

- [Resources](/guides/resources) — share files and context across a Workspace.
- [Git](/guides/git) — run Git workflows against an attached folder.
- [Safety Rules](/guides/safety-rules) — constrain what an Assistant can do.
- [Configuration](/getting-started/configuration) — set environment variables like `EXTERNAL_FOLDERS_HOST_PATH`.
