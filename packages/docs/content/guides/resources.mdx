...
See [The Canvas](/guides/canvas) for general canvas and card mechanics.
...
All responses use the standard envelope: `{ success, data?, error?, meta? }`. See the [API reference](/reference/api).
