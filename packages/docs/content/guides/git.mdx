...
In other words, **viewers can read the Git panel** — Status, Log, Branches, and Diffs — **but cannot stage, unstage, commit, create or switch branches, or push.** Those mutating actions require the editor (write) role. See [Users & Roles](/guides/users) for the full capability matrix.
...
<Cards>
  <Cards.Card title="Workspaces & Canvas" href="/guides/canvas" />
