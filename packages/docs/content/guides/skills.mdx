...
<Cards.Card title="Connections" href="/docs/guides/connections" />
<Cards.Card title="Terminology (glossary)" href="/docs/concepts/terminology" />
<Cards.Card title="Skills API reference" href="/docs/reference/api" />
</Cards>
