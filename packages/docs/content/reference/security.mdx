...
See the [Users guide](/docs/guides/users) for how roles map to day-to-day actions and how admins manage accounts.

## Safety Rule enforcement

[Safety Rules](/docs/guides/safety-rules) (Policies) constrain what an Assistant may do, and they resolve with **most-restrictive-wins** semantics across three layers — global, agent, and session.
